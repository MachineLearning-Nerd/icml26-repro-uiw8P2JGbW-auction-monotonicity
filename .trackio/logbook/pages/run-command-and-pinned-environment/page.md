...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_ea2cdc83ba06", "created_at": "2026-07-25T11:36:43+00:00", "title": "Pinned pyproject.toml and uv.lock (complete, inline)"}
-->
```toml
# pyproject.toml
[project]
name = "auction-monotonicity-repro"
version = "0.2.0"
description = "Independent reproduction of Model Monotonicity in Autobidding Auctions (arXiv 2605.31036, OpenReview uiw8P2JGbW)."
...
[package.metadata]
requires-dist = [
    { name = "numpy", specifier = ">=1.26,<3.0" },
    { name = "pytest", specifier = ">=7.4,<9.0" },
    { name = "scipy", specifier = ">=1.11,<2.0" },
