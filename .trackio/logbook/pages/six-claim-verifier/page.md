...
---
<!-- trackio-cell
{"type": "code", "id": "cell_8bf36ac455df", "created_at": "2026-07-22T11:57:01+00:00", "title": "Run: env verify_auction_claims.py (exit 0)", "command": ["env", "PYTHONPATH=.", ".venv/bin/python", "repro/src/verify_auction_claims.py"], "exit_code": 0, "duration_s": 0.409}
-->
````bash
$ env PYTHONPATH=. .venv/bin/python repro/src/verify_auction_claims.py
````

exit 0 · 0.4s


````python title=verify_auction_claims.py
...
````output
{
  "C1_refinement_revenue": {
    "cases": 2000,
    "min_jensen_gap": -1.7763568394002505e-15
  },
  "C2_calibration_necessity_negative_control": {
    "min_wrong_model_gap": -6.263522500523175,
    "negative_cases": 998
  },
  "C3_t_cpa_mu_one_optimality": {
    "instances": 500,
    "violations": 0
  },
  "C4_vcg_t_cpa_nonmonotonicity": {
    "coarse": 3.23,
    "fine": 3.03,
    "loss_pct": 6.191950464396291
  },
  "C5_budgeted_fpa_nonmonotonicity": {
    "coarse": 5.5267555,
    "coarse_winners": [
      1,
      1,
